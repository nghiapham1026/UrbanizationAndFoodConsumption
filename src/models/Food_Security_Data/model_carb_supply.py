...
undernourished_data = data[data['Item'] == 'Share of dietary energy supply derived from cereals, roots and tubers (kcal/cap/day) (3-year average)']
...
plt.title('Average Carbohydrates Supply per Day')
plt.xlabel('Year')
plt.ylabel('Amount of Carbohydrates Intake (g/cap/day)')
